...
\begin{itemize}[leftmargin=*]
	\item \textbf{TP-UT-001 Innovation tracking consistency.}\\
	      \textbf{Owner:} Oğuzhan Özkaya.\\
	...
	\item \textbf{TP-UT-002 Mutation preserves executable genomes.}\\
	      \textbf{Owner:} Oğuzhan Özkaya.\\
	...
	\item \textbf{TP-UT-003 Crossover produces valid offspring.}\\
	      \textbf{Owner:} Oğuzhan Özkaya.\\
	...
	\item \textbf{TP-UT-004 Sensor vector encoding correctness.}\\
	      \textbf{Owner:} Emir Irkılata.\\
...
\begin{itemize}[leftmargin=*]
	\item \textbf{TP-IT-001 Config validation and override rejection.}\\
	      \textbf{Owner:} Caner Aras.\\
	      \textbf{Procedure:} Run \texttt{just validate} and repeat validation with intentionally
	      invalid \texttt{--set} values.\\
	      \textbf{Expected result:} Valid configurations print \texttt{OK}; invalid values report
	      field-specific errors and stop execution.

	\item \textbf{TP-IT-002 Headless run artifact generation.}\\
	      \textbf{Owner:} Caner Aras.\\
	...
	\item \textbf{TP-IT-003 Analysis pipeline integration.}\\
	      \textbf{Owner:} Caner Aras.\\
	...
	\item \textbf{TP-IT-004 Profiler pipeline integration.}\\
	      \textbf{Owner:} Caner Aras.\\
	      \textbf{Procedure:} Build the profiler path and execute \texttt{just profile-run}; then
	      execute \texttt{just profile-analyse}.\\
	      \textbf{Expected result:} Profiler JSON is written under \texttt{output/profiles/} and
	      an HTML report is generated under \texttt{profiler/output/}.

	\item \textbf{TP-ST-001 GUI startup and shutdown.}\\
	      \textbf{Owner:} Emir Irkılata.\\
	...
	\item \textbf{TP-ST-002 CPU fallback path.}\\
	      \textbf{Owner:} Emir Irkılata.\\
	...
	\item \textbf{TP-ST-003 Experiment discovery and selection.}\\
	      \textbf{Owner:} Caner Aras.\\
	      \textbf{Procedure:} Execute \texttt{just list-experiments}; then run one named
	      experiment with \texttt{--experiment}.\\
	      \textbf{Expected result:} The executable lists known experiments and runs the selected
	      one without manual config edits.

	\item \textbf{TP-ST-004 Cross-platform CI regression.}\\
	      \textbf{Owner:} Caner Aras.\\
	      \textbf{Procedure:} Trigger or inspect the implemented CI workflows for Linux and
	      Windows Debug and Release jobs.\\
	      \textbf{Expected result:} Each job configures, builds, and runs the test suite without
	      failure before merge or release packaging.
\end{itemize}

\subsection{Performance, Acceptance, and Beta Test Cases}

\begin{itemize}[leftmargin=*]
	\item \textbf{TP-PT-001 Release-build frame-time profiling.}\\
	      \textbf{Owner:} Oğuzhan Özkaya.\\
	...
	\item \textbf{TP-PT-002 GPU performance inspection.}\\
	      \textbf{Owner:} Oğuzhan Özkaya.\\
	...
	\item \textbf{TP-UAT-001 Internal GUI usability smoke pass.}\\
	      \textbf{Owner:} Emir Irkılata.\\
	      ...
	      \textbf{Expected result:} Core controls respond correctly and the displayed simulation
	      state remains usable for inspection.

	\item \textbf{TP-UAT-002 Internal experiment workflow acceptance.}\\
	      \textbf{Owner:} Caner Aras.\\
	      ...
	      \textbf{Expected result:} A project user can complete the standard experiment workflow
	      without changing the source code.

	\item \textbf{TP-BT-001 Closed internal beta smoke pass.}\\
	      \textbf{Owner:} Emir Irkılata.\\
	      \textbf{Procedure:} Before final submission, the team repeats the core system,
	      analysis, and performance-related smoke checks on the release-candidate state.\\
	      \textbf{Expected result:} No blocking regression remains in build, test, runtime,
	      profiling, or core experiment workflows.
\end{itemize}
